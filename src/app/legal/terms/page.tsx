      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Conditions Générales d'Utilisation</h1>
              <p className="text-gray-600 mt-2">Règles d'utilisation du service OrderSpot.pro</p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <p className="text-gray-700">
              ...
              de la plateforme OrderSpot.pro, service d'assistant vocal intelligent pour restaurants.
            </p>
          </div>
          
          <div className="bg-gray-50 rounded-xl p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Acceptation</h2>
            <p className="text-gray-700">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <p className="text-gray-700">
              Pour toute question : <strong>contact@orderspot.pro</strong>
            </p>
          </div>
        </div>
      </div>
