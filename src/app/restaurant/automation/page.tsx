...
const integrations = [
    {
        name: 'Stripe',
        description: 'Connectez votre compte Stripe pour accepter les paiements par carte bancaire et gérer les abonnements.',
        logo: '/stripe-logo.svg', // Assurez-vous d'avoir le logo dans votre dossier public
        status: 'disconnected',
    },
    // Ajoutez d'autres intégrations ici
];
...
export default function AutomationPage() {
    ...
    const handleConnectStripe = () => {
        // Rediriger vers le flux OAuth de Stripe
